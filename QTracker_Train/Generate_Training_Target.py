...
while(n_train<1e7):
    ...
    print(n_train)
    np.save('Target_Train_In.npy',np.concatenate((train_input)))
    np.save('Target_Val_In.npy',np.concatenate((val_input)))
    np.save('Target_Train_Out.npy',np.concatenate((train_kinematics)))
    np.save('Target_Val_Out.npy',np.concatenate((val_kinematics)))

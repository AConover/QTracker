...
valin_reco = np.load("Target_Val_In.npy")
trainin_reco = np.load("Target_Train_In.npy")

valkinematics = np.load("Target_Val_Out.npy")
trainkinematics = np.load("Target_Train_Out.npy")
...
model.save('Reconstruction_Target')

...
# Load data
target_reco_train = np.load('target_kinematics_train.npy')
target_tracks_train = np.load('target_tracks_train.npy')
...
target_reco_val = np.load('target_kinematics_val.npy')
target_tracks_val = np.load('target_tracks_val.npy')
...
# Load data
dump_reco_train = np.load('dump_kinematics_train.npy')
dump_tracks_train = np.load('dump_tracks_train.npy')
...
dump_reco_val = np.load('dump_kinematics_val.npy')
dump_tracks_val = np.load('dump_tracks_val.npy')

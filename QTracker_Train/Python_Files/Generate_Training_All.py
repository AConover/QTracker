...
pos_events, pos_drift, pos_kinematics, neg_events, neg_drift, neg_kinematics = read_root_file('Root_Files/All_Vertex_Train_QA_v2.root')
pos_events_val, pos_drift_val, pos_kinematics_val, neg_events_val, neg_drift_val, neg_kinematics_val = read_root_file('Root_Files/All_Vertex_Val_QA_v2.root')
...
while(n_train<1e7):
    ...
    np.save('Training_Data/All_Val_In.npy',np.concatenate((val_input)))
    np.save('Training_Data/All_Val_Out.npy',np.concatenate((val_kinematics)))
    np.save('Training_Data/All_Train_In.npy',np.concatenate((train_input)))
    np.save('Training_Data/All_Train_Out.npy',np.concatenate((train_kinematics)))
